  ...
  return (
      <>
        ...
        {userFolders && userFolders.length > 0 && (
            <>
              <p className="text-left  py-2" style={{marginLeft: "40px"}}>Mood Album /</p>
        ...
        {createdUserFiles && createdUserFiles.length > 0 && (
            <>
              <p className="text-left  py-2"  style={{marginLeft: "40px"}} >Created Files /</p>
              <Row style={{ height: 'auto' }} className="pt-2 gap-2 pb-4 px-5">
        ...
        {uploadedUserFiles && uploadedUserFiles.length > 0 && (
            <>
              <p className="text-left  py-2" style={{marginLeft: "40px"}}>Upload Files /</p>
              <Row
                  md="2"
                  style={{height: 'auto'}}
